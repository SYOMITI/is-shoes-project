...
<head>
  ...
  <title>Bata Shoes Management System - OTP Page</title>
            ...
            <div class="col-md-9 mx-auto">
              <div class="contact-form">
                <form action="php/authentication.php" method="POST">
                  ...
                  ?>
                  <div>
                    <input type="password" placeholder="One Time Password" required name="itp">
                  </div>                 
                  <div class="d-flex justify-content-center">
                    <button type="submit" class="btn_on-hover" name="login">
                      Verify
                    </button>
                    <br>
                    <br>
